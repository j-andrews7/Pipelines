...
while (my $line=<IN>){ 
    ...
    my @data = split("\t", $line);
    if (($data[10] >= 1.5 || $data[10] == 0) && ($data[11] >= 1.5 || $data[11] == 0) && ($data[12] >= 1.5 || $data[12] == 0)){
    #if (($data[10] >= 1.5 || $data[11] >= 1.5 || $data[12]>=1.5)){ #  || $data[13]>0
        if (exists $prom{$data[14]}) {
            print UP "$line\n";
        }
        
    
    }if (($data[10] <= 0.666 || $data[10] == 0) && ($data[11] <= 0.666 || $data[11] == 0) && ($data[12] <= 0.666 || $data[12] == 0)){
    #if (($data[10]<= 0.666 && $data[10] != 0) || ($data[11] <= 0.666 && $data[11] != 0) || ($data[12] <= 0.666 && $data[12] != 0)){
