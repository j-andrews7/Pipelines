...
if (@ARGV != 3){ die "\nUsage: perl $0 <FL_circuits_file> <Limitbasic_file> <Jackie's file>\n\n"}
...
open(PROM, ">promoterALL_$file") or die "Could not open file: promoter_$file\n";

open(ENHAN, ">enhancerALL_$file") or die "Could not open file: enhancer_$file\n";
...
open(ENHAN, "<enhancerALL_$file") or die "Could not open file: enhancer_$file\n";
open(OUT, ">noprom_enhancerALL_$file") or die "Could not open file: noprom_enhancer_$file\n";
